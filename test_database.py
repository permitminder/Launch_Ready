"""
Test script for PermitMinder database utility.
"""
...
def test_database():
    ...
    """
    st.title("PermitMinder Database Utility Test")
    ...
    try:
        ...
        severities = get_unique_values(df, 'SEVERITY')
    ...
    try:
        # Example filter: First county, moderate severity
        if len(counties) > 1 and len(severities) > 0:
