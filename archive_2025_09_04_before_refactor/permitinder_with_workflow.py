...
def show_search_page():
    ...
    # Results section - REMOVED DUPLICATE HEADING
    ...
    if len(restricted_df) > 0:
        ...
        # Apply alternating row colors directly with pandas styling - FROM VERSION 22
        ...
        # Apply styling - FROM VERSION 22
        styled_df = permit_summary.style.apply(style_alternating_rows, axis=None)
        
        # Display styled dataframe - FROM VERSION 22
        st.dataframe(
            styled_df,
